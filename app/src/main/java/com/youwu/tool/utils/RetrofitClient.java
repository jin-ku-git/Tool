...
//    public static String baseUrl = "https://apis.map.qq.com/ws/";//腾讯地图
//    public static String baseUrl = "https://tools.youwuu.com/";//马增光
    public static String baseUrl = "https://cabinet-tools.youwuu.com/";//线上
...
//                .addInterceptor(new MonitorInterceptor(mContext))//抓包
