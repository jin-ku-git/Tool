...
public class RxToast {
    ...
    //粉色
    @ColorInt
    private static final int PINK_PINKGROUND_COLOR = Color.parseColor("#F3B2D2");
    //绿色
    @ColorInt
    ...
    //pink
    public static void pink(@NonNull String message) {
        pink(getContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void pink(@NonNull String message, int duration) {
        pink(getContext(), message, duration, true).show();
    }
    public static Toast pink(@NonNull String message, int duration, boolean withIcon) {
        return custom(getContext(), message, getDrawable(getContext(), R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, PINK_PINKGROUND_COLOR, duration, withIcon, true);
    }
    ...
    @CheckResult
    private static Toast pink(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, getDrawable(context, R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, PINK_PINKGROUND_COLOR, duration, withIcon, true);
    }
