...
import com.cretin.www.update.utils.AppUtils;
...
public class UpdateType11Activity extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_type11);
    ...
    public AppDownloadListener obtainDownloadListener() {
        return new AppDownloadListener() {
            ...
            public void downloadFail(String msg) {
                ...
                Toast.makeText(UpdateType11Activity.this, ResUtils.getString(R.string.apk_file_download_fail), Toast.LENGTH_SHORT).show();
            }
    ...
    public static void launch(Context context, DownloadInfo info) {
        launchActivity(context, info, UpdateType11Activity.class);
    }
