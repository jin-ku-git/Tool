...
public class UpdateType7Activity extends RootActivity {
    ...
    public AppDownloadListener obtainDownloadListener() {
        return new AppDownloadListener() {
            ...
            public void downloadFail(String msg) {
                ...
                Toast.makeText(UpdateType7Activity.this, ResUtils.getString(R.string.apk_file_download_fail), Toast.LENGTH_SHORT).show();
            }
    ...
    public static void launch(Context context, DownloadInfo info) {
        launchActivity(context, info, UpdateType7Activity.class);
    }
